...
public abstract class Shader {
    ...
    protected void setUniform(String name, float x, float y, float z) {
        glUniform3f(locationOf(name), x, y, z);
    }
    
    protected void setUniform(String name, Light light) {
        glUniform3f(locationOf(name), light.getX(), light.getY(), light.getZ());
    }
