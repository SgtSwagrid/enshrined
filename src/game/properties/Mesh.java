...
public class Mesh {
     ...
     */
    public Mesh(float[] vertices, float[] texmap, float[] normals) {
     ...
     */
    public int getVaoId() {
        if(vaoId == -1) vaoId = createVao(vertices, texmap, normals);
        return vaoId;
    }
     ...
     * @return VAO ID.
     */
    private int createVao(float[] vertices, float[] textures, float[] normals) {
        ...
        List<Integer> vbos = new ArrayList<>(3);
        vbos.add(createVbo(0, vertices, 3));
        vbos.add(createVbo(1, textures, 2));
        vbos.add(createVbo(2, normals, 3));
